...
(function initActionableCardContractQueueNoteV966(root) {
  ...
  function updateQueue() {
    ...
    item.latestActionabilityCorrectionDetail = 'v9.66 keeps the notes-first queue moving, but adds an actionability contract so note-derived Next Steps cards must include commands or concrete GUI workflow, expected evidence, failure modes, and next-step guidance. Pure conceptual lessons should enrich existing cards as field notes instead of becoming vague standalone cards.';
    return true;
  }
  function install() {
