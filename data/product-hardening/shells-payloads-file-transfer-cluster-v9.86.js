'use strict';
(function(root){
const W='v9.86-shells-payloads-file-transfer-stabilization';
const ACTIVE='source-note-cluster-shells-payloads-and-file-transfer-stabilization';
const CLUSTER='shells-payloads-and-file-transfer-stabilization';
const NEXT='source-note-cluster-linux-privesc-enumeration-and-proof';
const REVIEW_TEXT_CHARS=445028;
const NOTE_COUNT=24;
const SHELL='listener-and-shell-stabilization-card';
const MSF='metasploit-resource-pivot-workflow';
...
const PUBLIC_NOTES=[
 ...
 ['note-file-transfer-method-boundary-v986','File transfer proof needs source, destination, and integrity','A transfer command is not enough. Record served file, destination path, execution permission, hash or size where practical, and cleanup. Choose HTTP, SMB, SCP, certutil, iwr, curl, wget, or copy-paste based on the host and egress.','tool-guidance',[SHELL,UPLOAD],['file-transfer','http','smb','cleanup'],['python3','smbserver.py','certutil','curl','wget','iwr']],
