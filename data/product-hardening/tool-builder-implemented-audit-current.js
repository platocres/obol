...
function proofGateLanguage(text){return /proof-gated|risk-gated|evidence-gated|run gated|try gated|generate a gated|risk gate:|cannot generate[^.]{0,80}evidence|requires evidence[^.]{0,80}generate/i.test(text);}
