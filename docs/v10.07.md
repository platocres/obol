...
v10.07 is a product-hardening release that completes the shell, payload, privilege-enumeration, listener, and transfer helper batch from the active Tool Builder implementation queue.
