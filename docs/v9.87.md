...
- Does not create Linux service, SUID, kernel, or local-exploit wrapper cards.
...
- Checks the new primary card action spine, field-note bindings, analyzer redaction, intake integration, queue handoff, and downstream cluster generation.
