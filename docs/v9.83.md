...
The dashboard proof is intentionally tied to the same queue handoff that regenerates the README Product Build Next block so future agents can catch dashboard drift before a release is called merge-ready.
