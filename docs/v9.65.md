...
CI remains the source of truth for full-repository and browser validation. The final merge check should run on a human-authored head after generated artifacts sync.
