...
Most note-mined material should enrich an existing Orange-map card as collapsible field notes, gotchas, evidence expectations, troubleshooting notes, or tool-usage tips.
...
- expected evidence to paste back,
- failure modes,
- next-step guidance,
- path state it produces,
- evidence or analyzer facts that make it relevant.
