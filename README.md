...
**Recommended work package:** **Post-notes Operator UI Clarity** — 2 concrete live items / 5 tracked.
**Next concrete entry:** **Post-mining Tools builder-library cleanup**
...
1. **Post-mining Tools builder-library cleanup** — Rework Tools from a tab-per-tool matching-card dump into a grouped builder launcher with implemented builders first and legacy matching cards behind deliberate drilldown.
2. **Post-mining visual density regression pass** — Add browser checks and screenshot targets that prove the Path, Card, and Tools cleanup reduced clutter without weakening action, evidence, or decision guidance.
