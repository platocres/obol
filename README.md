...
**Source re-mining status:** 67/135 full-spectrum re-mined; 68 old-rubric-only notes remain.
...
1. **Re-mine all already-reviewed notes from original sources** — Concrete notes-first gate: 68 already-reviewed old-rubric-only notes still need full-spectrum source re-mining before offline/performance work can become next.
