...
// Current release wiring contract: methodology-v6.6.js dashboard-v6.6.js core-v6.6.js
...
function render(){
  const p=C.projectModel66(C.newState(),lanes),q=p.buildNext,c=p.canonical,s=p.source,n=p.next;
  return [
    START,
    ...
    n?`**Next priority:** **${clean(n.label)}** — ${clean(n.kind).replace(/-/g,' ')}.`:'**Next priority:** No queued items.',
    '',
