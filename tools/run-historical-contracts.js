...
const PHASE_TASKS=Object.freeze({
 ...
 'v9-current-product':[
  ['tests/run-v10.02-tests.js'],['tests/run-v10.03-tests.js'],['tests/run-v10.04-tests.js'],['tests/run-v10.05-tests.js'],['tests/run-v10.06-tests.js'],['tests/run-v10.07-tests.js'],['tests/run-v10.08-tests.js'],['tests/run-v10.09-tests.js'],['tests/run-v10.10-tests.js'],['tests/run-v10.11-tests.js'],['tests/run-v10.12-tests.js'],['tests/run-v10.13-tests.js'],['tests/run-v10.14-tests.js'],['tests/run-v10.15-tests.js'],['tests/run-v10.16-tests.js'],['tests/run-v10.17-tests.js'],['tests/run-v10.18-tests.js'],['tests/run-v10.19-tests.js'],['tests/run-v10.20-tests.js'],['tests/run-v10.21-tests.js'],['tests/run-v10.22-tests.js'],['tests/run-v10.23-tests.js'],['tests/run-v10.24-tests.js'],['tests/run-tool-builder-database-acceleration-tests.js'],['tests/run-tool-builder-web-guidance-repair-tests.js'],['tests/run-tool-surface-contract-tests.js'],['tests/run-tool-builder-command-generation-tests.js'],['tests/run-tool-credential-auth-guidance-tests.js'],['tests/run-tool-builder-credential-evidence-tests.js'],['tests/run-tool-ad-smb-guidance-tests.js'],['tests/run-tool-builder-ad-smb-command-controls-tests.js'],['tests/run-tool-builder-ad-smb-evidence-tests.js'],['tests/run-notes-batch-selector-tests.js'],['tools/validate-current-release.js'],['tools/validate-product-hardening-queue.js'],['tools/validate-version-identity.js'],['tools/validate-live-integration-done-gate.js']
 ],
