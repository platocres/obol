...
const PHASE_TASKS=Object.freeze({
 ...
 'v9-current-product':[
  ['tests/run-v10.02-tests.js'],['tests/run-v10.03-tests.js'],['tests/run-v10.04-tests.js'],['tests/run-v10.05-tests.js'],['tests/run-v10.06-tests.js'],['tests/run-v10.07-tests.js'],['tests/run-notes-batch-selector-tests.js'],['tools/validate-current-release.js'],['tools/validate-product-hardening-queue.js'],['tools/validate-version-identity.js'],['tools/validate-live-integration-done-gate.js']
 ],
