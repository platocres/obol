...
const syntaxFiles=['tools/release-smoke.js','tools/sync-readme-build-next.js','tools/release-preflight.js','tools/validate-release-pr.js','tools/validate-release-quality.js',currentTest];
if(isProductHardening){
  syntaxFiles.push('data/current-release.js','data/runtime-manifest.js','assets/runtime-current.js','data/product-hardening/product-hardening-queue.js','data/product-hardening/item-test-contracts.js','data/tool-builder-schema.js','data/tool-builder-inventory.js','data/tool-builders.js','assets/tool-builder-current.js','tools/validate-current-release.js','tools/validate-version-identity.js','tools/validate-accessibility-contract.js','tools/validate-responsive-layout.js','tools/validate-tool-builder-platform.js','tools/validate-current-workflow.js','tools/validate-current-boot.js','tools/validate-path-views.js','tools/validate-current-owner-styles.js','tools/validate-field-notes-ui.js','tools/validate-runtime-loading.js','tools/validate-runtime-manifest.js','tools/sync-domain-current.js','tools/validate-domain-current-equivalence.js','tools/sync-core-current.js','tools/validate-core-current-equivalence.js','tools/sync-app-current.js','tools/validate-app-semantic-current.js','tools/validate-app-current-equivalence.js','tools/validate-app-dom-equivalence.js','tools/validate-evidence-current-equivalence.js','tools/validate-dashboard-compat-equivalence.js','tools/validate-dashboard-freshness.js','tools/audit-dashboard-runtime-dependencies.js','tools/style-cascade-current.js','tools/sync-current-styles.js','tools/validate-style-current-equivalence.js','tools/validate-style-visual-equivalence.js','tools/sync-current-release.js','tools/validate-product-hardening-queue.js','tools/validate-asset-references.js','tools/sync-product-build-next.js','tools/validate-open-pr-uniqueness.js','tools/validate-readme-history-ownership.js');
}else{
...
if(isProductHardening){
  ...
  run('single-paint current boot ownership',['tools/validate-current-boot.js']);
  run('Path three-mode rendering',['tools/validate-path-views.js']);
  run('current-owner style delivery',['tools/validate-current-owner-styles.js']);
  ...
  run('stylesheet semantic equivalence',['tools/validate-style-current-equivalence.js']);
