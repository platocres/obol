...
assert.strictEqual(field.entries.length,49,'forty-nine normalized public field notes are exposed (v9.52 added the Windows service-trigger/tool-proof re-mining output)');
