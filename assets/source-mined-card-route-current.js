...
const SOURCE_CARD_IDS=LINUX_CARD_IDS.concat(WEB_CARD_IDS);
const WEB_REVIEW_PACKET='platocres/obol-source-notes@agent/review-packets:data/review-packets/htb-penetration-tester-03.json';
