// Obol v6.7 UI delta — keep the consolidated v6.6 Dashboard shell on the current v6.7 project model and surface the delivered AD CS wave.
'use strict';
(function(){
