...
const analysis=wave&&globalThis.OBOL_WINDOWS_CREDENTIAL_DUMPING_SECRETS_PACKET_V984.analyze('Get-Process lsass; rundll32 C:\\Windows\\System32\\comsvcs.dll, MiniDump 672 C:\\Temp\\lsass.dmp full. pypykatz lsa minidump lsass.dmp showed == MSV == Username bob NT: 64f12cddaa88057e06a81b54e73b949b DPAPI masterkey e8bc2faf77e7bd1891c0e49f0dea9d447a491107ef5b25b9929071f68db5b0d55bf05df5a474d9bd94d98be4b4ddb690e6d8307a86be6f81be0d554f195fba92. reg save HKLM\\SAM sam.save and secretsdump.py -sam sam.save -system system.save LOCAL. <property name="hibernate.connection.password">D@t4basePassw0rd!</property> {PKCS5S2}WbziI52BKm4DGqhD1/mCYXPl06IAwV7MG7UdZrzUqDG8ZSu15/wyt3XcVSOBo6bC. hashcat recovered candidate. nxc smb 192.168.50.10 -u bob -H 64f12cddaa88057e06a81b54e73b949b --shares Pwn3d! OS{secret} Answer: flag');
...
assert.ok(!/64f12cdd|e8bc2f|D@t4base|PKCS5S2|192\.168|OS\{|Answer: flag|bob/i.test(JSON.stringify(analysis)),'analysis output should be redacted/public-safe');
