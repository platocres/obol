...
assert(readme.includes('docs/TOOL-BUILDER-BUILD-QUEUE.md'),'README must link to the canonical Tool Builder queue instead of duplicating completed slices as active work');
