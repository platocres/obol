...
assert.strictEqual(Number(q.nextNotesBatch.noteCount||q.nextNotesBatch.targetCount||q.nextNotesBatch.count),33);
assert.ok(/whole cluster/i.test(q.nextNotesBatch.acceptance||''));
