...
for(const token of ['installSlice','patchInventory','patchEvidence','installIntake','safeRegister','redactSecrets','stateFrom']){
...
assert(database.includes('sharedPlumbingVersion'),'database owner should expose the shared plumbing version it used');
