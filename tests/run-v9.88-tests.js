...
for(const id of contextCards){const card=globalThis.CARDS&&globalThis.CARDS[id];if(card)assert.ok(!((card.featureIds||[]).includes('windows-privesc-services-local-admin-router')),'context card should not become another v9.88 primary owner '+id);}
