...
// the v9.77-v9.79 cluster-mining extensions. They still fail loudly if the
// historical fragment chain leaks back into loading.
const routes = [
  { id: 'home', hash: '#/home', marker: /Home/i, requestBudget: 59 },
  { id: 'targets', hash: '#/boxes', marker: /target/i, requestBudget: 65 },
  { id: 'evidence', hash: '#/intake', marker: /evidence/i, requestBudget: 62 },
  { id: 'next-steps', hash: '#/path', marker: /(next|path|recommend)/i, requestBudget: 66 },
  { id: 'report', hash: '#/report', marker: /report/i, requestBudget: 61 },
  { id: 'dashboard', hash: '#/dashboard', marker: /Product Hardening/i, currentDashboard: true, settleMs: 5200, requestBudget: 60 }
];
