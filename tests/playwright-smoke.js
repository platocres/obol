...
// the v9.77-v9.80 cluster-mining extensions. They still fail loudly if the
// historical fragment chain leaks back into loading.
const routes = [
  { id: 'home', hash: '#/home', marker: /Home/i, requestBudget: 60 },
  { id: 'targets', hash: '#/boxes', marker: /target/i, requestBudget: 66 },
  { id: 'evidence', hash: '#/intake', marker: /evidence/i, requestBudget: 63 },
  { id: 'next-steps', hash: '#/path', marker: /(next|path|recommend)/i, requestBudget: 67 },
  { id: 'report', hash: '#/report', marker: /report/i, requestBudget: 62 },
  { id: 'dashboard', hash: '#/dashboard', marker: /Product Hardening/i, currentDashboard: true, settleMs: 5200, requestBudget: 61 }
];
