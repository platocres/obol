...
// web Evidence pack, and the v10.10 Burp Suite guided workflow builder plus
// current Tools-home reclaim guard on tool-bearing and dashboard/current routes.
...
const routes = [
  ...
  { id: 'evidence', hash: '#/intake', marker: /evidence/i, requestBudget: 88 },
